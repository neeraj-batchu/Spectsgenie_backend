...
const { getAllProducts, getProductById, addProduct,getProductsByDynamicQuery,searchProduct, getWishlistStatusById, getSimilarProductsByCategory } = require("../controller/productController");
